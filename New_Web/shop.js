...
const productsDatabase = [
  ...
  },
  {
    ...
    rating: 5,
    reviews: 156,
    image: "Samsung Galaxy S22 Ultra.png",
    features: ["5 Days Refund"],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    rating: 4,
    reviews: 134,
    image: "Dell Latitude 7420 Core i7 - 11th Gen.png",
    features: ["5 Days Refund"],
  },
  {
    id: 9,
    ...
    rating: 4,
    reviews: 76,
    image: "HP Elitebook 640 G4 Core-i5 8th Gen.jpg",
    features: ["5 Days Refund"],
  },
  ...
  // Tablets
  {
    ...
    rating: 4,
    reviews: 67,
    image: "iPad 9th Gen 2021 Wi-Fi.jpg",
    features: ["5 Days Refund"],
  },
  {
    id: 11,
    ...
    rating: 4,
    reviews: 89,
    image: "iPad 8th Gen 2020 Wi-Fi.png",
    features: ["5 Days Refund"],
  },
  ...
  },
  {
    ...
    rating: 5,
    reviews: 178,
    image: "JBL Earbuds Wave-200 TWS.jpg",
    features: ["5 Days Refund"],
  },
  {
    id: 14,
  ...
  // Gaming Consoles
  {
    ...
    rating: 5,
    reviews: 289,
    image: "PlayStation 4 Controller.png",
    features: ["5 Days Refund"],
  },
  {
    id: 18,
...
function createProductCard(product) {
  ...
  // Get storage/RAM/GPU info based on product category
  let specs = ""
  if (product.storage) {
    specs += product.storage
  }
  if (product.ram) {
    specs += (specs ? " | " : "") + product.ram
  }
  if (product.gpu) {
    specs += (specs ? " | " : "") + product.gpu
  }
  if (product.screenSize) {
    specs += (specs ? " | " : "") + product.screenSize
  }
  ...
  col.innerHTML = `
    <div class="product-card" data-category="${product.category}" data-brand="${product.brand}" 
      ...
      <div class="color-options mb-2">
        <span class="color-dot" style="background: #1f1f1f;"></span>
        <span class="color-dot" style="background: #f9d8c8;"></span>
        <span class="color-dot" style="background: #c4c4c4;"></span>
        ${product.color ? `<span class="more-colors">+${product.color}</span>` : ""}
      </div>
      ${specs ? `<p class="product-specs">${specs}</p>` : ""}
